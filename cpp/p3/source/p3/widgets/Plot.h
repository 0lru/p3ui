...
public:
    ...
    public:
        ...
        void set_line_weight(float);
        float line_weight() const { return _line_weight; }
...
{
    ImPlot::PlotInfLines(this->name().c_str(), this->values().data(), static_cast<int>(this->values().size()), ImPlotInfLinesFlags_Horizontal);
}
